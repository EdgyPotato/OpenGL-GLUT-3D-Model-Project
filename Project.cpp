//	Note: this program is create using OpenGL Freeglut library and VSCode
...
void rightArm() {
	...
	glRotatef(-90.0f, 0.0f, 1.0f, 0.0f);
	glutSolidCylinder(0.35f, 5.2f, 20, 20);
	glPopMatrix();
}
...
void rightLeg() {
	...
	glutSolidCylinder(0.35f, 4.5f, 20, 20);
	//boot
	glColor3f(0.15f, 0.13f, 0.12f);
	glPushMatrix();
	glTranslatef(0.0f, 0.0f, 3.5f);
	glutSolidCylinder(0.45f, 1.5f, 20, 20);
	glPopMatrix();
	glPushMatrix();
	glRotatef(-90.0f, 1.0f, 0.0f, 0.0f);
